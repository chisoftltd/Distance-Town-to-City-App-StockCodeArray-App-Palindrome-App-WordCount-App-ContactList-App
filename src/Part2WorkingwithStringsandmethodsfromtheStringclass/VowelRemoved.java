 ...
 * 
 * Write a Java program that reads a string from the user and prints the same 
 * string but with all occurrences of vowels removed. 
 * For example, the input string "abcdefghijk" will be printed "bcdfghjk".
 * 
 */
public class VowelRemoved {
